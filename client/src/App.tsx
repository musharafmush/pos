...
import LabelPrintingHub from "@/pages/label-printing-hub";
...
function Router() {
  return (
    <Switch>
      ...
      <ProtectedRoute path="/label-printing-hub" component={LabelPrintingHub} />
      ...
      <ProtectedRoute path="/image-based-labels" component={ImageBasedLabels} />
