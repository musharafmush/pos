      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Configure currency display and exchange rate settings for your POS system.
          </p>
        </div>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                      {popularCurrencies.slice(0, 12).map((currency) => (
                        <Button
                          key={currency.code}
                          type="button"
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-6">
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                      <div className="space-y-0.5">
                        <FormLabel className="text-base">Enable Multi-Currency</FormLabel>
                        <FormDescription>
                ...
                {form.watch("enableMultiCurrency") && (
                  <div className="space-y-4">
                    <FormField
                      control={form.control}
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Exchange Rate Provider</FormLabel>
                          <FormControl>
                            <Select onValueChange={field.onChange} value={field.value}>
                              <SelectTrigger>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base">Auto-Update Exchange Rates</FormLabel>
                            <FormDescription>
