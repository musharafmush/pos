  ...
  const navGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/repacking-system", icon: <PackageIcon className="h-5 w-5" />, label: "Repacking System" },
        { href: "/repacking-management", icon: <PackageIcon className="h-5 w-5" />, label: "Repacking Management" },
        { href: "/repacking-analytics", icon: <PackageIcon className="h-5 w-5" />, label: "Repacking Analytics" }
      ]
    },
    {
      id: "purchases",
